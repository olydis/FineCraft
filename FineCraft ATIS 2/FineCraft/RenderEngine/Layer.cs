...
namespace FineCraft.RenderEngine
{
    ...
    public class Layer
    {
        ...
        public int Push(LayerCell cell)
        {
            ...
            {
                new VertexAwesome(Color.White, screen[0],Vector3.UnitZ,tex[0]),
                new VertexAwesome(Color.White, screen[2],Vector3.UnitZ,tex[2]),
                new VertexAwesome(Color.White, screen[1],Vector3.UnitZ,tex[1]),
                new VertexAwesome(Color.White, screen[1],Vector3.UnitZ,tex[1]),
                new VertexAwesome(Color.White, screen[2],Vector3.UnitZ,tex[2]),
                new VertexAwesome(Color.White, screen[3],Vector3.UnitZ,tex[3]),
