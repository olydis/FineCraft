...
namespace FineCraft.RenderEngine
{
    public struct VertexAwesome : IVertexType
    {
        ...
        public VertexAwesome(Vector3 position, Vector3 normal, Vector2 textureCoordinate)
        {
            this.Normal = normal;
        ...
        public VertexAwesome(Color color, Vector3 position, Vector3 normal, Vector2 textureCoordinate)
        {
            this.Normal = normal;
            this.Position = position;
            this.TextureCoordinate = textureCoordinate;
