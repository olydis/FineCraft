...
namespace FineCraft.RenderEngine
{
    public class Renderer
    {
        ...
        public static GraphicsDevice CreateDevice()
        {
            ...
            pp.BackBufferWidth = Static.RenderTarget.Width;
            pp.BackBufferHeight = Static.RenderTarget.Height;
            pp.PresentationInterval = PresentInterval.Immediate;

            return new GraphicsDevice(GraphicsAdapter.DefaultAdapter, GraphicsProfile.Reach, pp);
        }
