...
namespace FineCraft.WorldGenerator
{
    public class Generator
    {
        ...
        {
            var gebirge = VolumeGenerator.getData2D(0xFF, position.X, position.Y, realExp, bufferExp, int.MaxValue, 0, 0x800);
            var height2 = VolumeGenerator.getData2D(1, position.X, position.Y, realExp, bufferExp, int.MaxValue, -0x1000, 0x2000);
