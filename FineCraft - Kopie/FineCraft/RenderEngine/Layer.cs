...
namespace FineCraft.RenderEngine
{
    ...
    public class Layer
    {
        public static void InitLayerRendering()
        {
            ...
            proj = Matrix.CreateScale(-1, 1, 1) * Matrix.CreateOrthographic(Static.Device.Viewport.Width, Static.Device.Viewport.Height, 0.1f, 1) * Matrix.CreateLookAt(Vector3.Zero, Vector3.UnitZ, Vector3.UnitY);
        }
        static Matrix proj;
        ...
        public void Render()
        {
            ...
            Static.Device.DrawUserPrimitives<VertexAwesome>(PrimitiveType.TriangleList, vertexBuffer, 0, 2 * index);
            Static.Effect.EndPass2D();
        }
    }
}
